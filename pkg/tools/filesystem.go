...
func (c *ConcurrentFS) Open(path string) (fs.File, error) {
	// Note: We delegate directly without holding a lock because the file remains open.
	// True concurrency control for streaming reads would require wrapping fs.File.
